...
if [ $# -eq 0 ]
  then
    ...
    node ./node_modules/protractor/bin/protractor protractorConf.scriptureforge.js --specs "./allspecs/e2e/*.spec.js,`find . -wholename "*scriptureforge*e2e*$1*.spec.js" -printf "%p,"|perl -p -e 's/,$//'`"
fi
