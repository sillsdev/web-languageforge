...
node $TESTDIR/node_modules/protractor/bin/protractor $1 $TESTDIR/protractorConf.languageforge.js --verbose --specs "$TESTDIR/allspecs/e2e/*.spec.js,`find . -wholename "*e2e*.spec.js" -printf "%p,"|perl -p -e 's/,$//'`"
