...
node $TESTDIR/node_modules/protractor/bin/protractor $TESTDIR/protractorConf.scriptureforge.js --baseUrl https://jamaicanpsalms.scriptureforge.local $2 --specs "$TESTDIR/allspecs/e2e/*.spec.js,`find . -wholename "*e2e*$1*.spec.js" -printf "%p,"|perl -p -e 's/,$//'`"
