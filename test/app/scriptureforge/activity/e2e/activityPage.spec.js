...
describe('Activity Page E2E Test', function () {
  ...
  var script = [
    ...
    { scope: 'comments',  action: 'edit',             value: 'This is an edited comment.' },
  ...
  // Utility function to determine if the current user will have the role permissions to do the
  // scope/action
    ...
    describe('Running as: ' + expectedUsername, function () {
      ...
      for (var i = 0; i < script.length; i++) {
        ...
        (function (currentScript) {
          ...
          it("Performing action '" + currentScript.action + "' on '" + currentScript.scope + "'",
          function () {
      ...
      while (scriptIndex >= 0) {
        ...
        (function (currentScript, activityIndex) {
          ...
          // Expect some combinations of username, script scope, action, and value to appear in the
          // activity feed
          it("Verify action '" + currentScript.action + "' on '" + currentScript.scope +
            "' appears on the activity feed",
          function () {
            ...
            // Truncate the ending 's' of the Scope string to partially match strings with different
            // scope tenses
