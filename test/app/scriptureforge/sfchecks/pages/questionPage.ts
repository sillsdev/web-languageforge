...
class Answers {
  ...
  add(answer: any) {
    ...
    browser.wait(ExpectedConditions.textToBePresentInElementValue(newAnswer, answer), this.utils.conditionTimeout);
  ...
  edit(answer: any) {
    ...
    browser.wait(ExpectedConditions.textToBePresentInElementValue(answersField, answer), this.utils.conditionTimeout);
    saveCtrl.click();
  }
  ...
  archive(index: any) {
    ...
    this.utils.clickModalButton('Delete');
  }
...
class Comments {
  ...
  addToLastAnswer(comment: any) {
    ...
    browser.wait(ExpectedConditions.visibilityOf(commentField), this.utils.conditionTimeout);
    commentField.sendKeys(comment);
    browser.wait(ExpectedConditions.textToBePresentInElementValue(commentField, comment), this.utils.conditionTimeout);
    submit.click();
  }
  ...
  edit(comment: any) {
    ...
    browser.wait(ExpectedConditions.textToBePresentInElementValue(commentsField, comment), this.utils.conditionTimeout);
    saveCtrl.click();
  }
