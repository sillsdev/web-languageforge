...
node $TESTDIR/node_modules/protractor/bin/protractor $1 $TESTDIR/protractorConfLF.js --verbose --specs "$TESTDIR/allspecs/e2e/*.spec.js,`find . -wholename "*e2e*.spec.js" -printf "%p,"|perl -pi -e 's/,$//'`"
