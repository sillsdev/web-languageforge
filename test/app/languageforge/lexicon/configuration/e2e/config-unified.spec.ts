...
describe('Configuration Fields', () => {
  ...
  describe('Member-Specific Settings', () => {
    ...
    it('can add a member-specific user settings', () => {
      ...
      expect<any>(configPage.unifiedPane.inputSystem.groupColumnCheckboxes(0).count()).toEqual(4);
    ...
    it('can add a second member-specific user settings', () => {
      ...
      expect<any>(configPage.unifiedPane.inputSystem.groupColumnCheckboxes(1).count()).toEqual(4);
