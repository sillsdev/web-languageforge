...
var LfDbePage = function() {
  ...
  this.browse = {
    ...
    search: {
      ...
      results: _this.browseDiv.element(by.css('div.typeahead')).all(by.repeater('e in typeahead.searchResults')),
      matchCountElem: _this.browseDiv.element(by.css('div.typeahead')).element(by.binding('typeahead.searchResults.length')),
  ...
  this.edit = {
    ...
    search: {
      ...
      results: _this.editDiv.element(by.css('div.typeahead')).all(by.repeater('e in typeahead.searchResults')),
      matchCountElem: _this.editDiv.element(by.css('div.typeahead')).element(by.binding('typeahead.searchResults.length')),
      getMatchCount: function() {
  ...
  this.comment = {
    ...
    newComment: {
      ...
      regardingDiv: _this.commentDiv.element(by.css('.newCommentForm')).element(by.css('.commentRegarding')),
      regarding: {
        clearBtn: _this.commentDiv.element(by.css('.newCommentForm')).element(by.css('.commentRegarding')).element(by.css('i.icon-remove')),
        fieldLabel: _this.commentDiv.element(by.css('.newCommentForm')).element(by.css('.commentRegarding')).element(by.css('.regardingFieldName')),
        fieldWsid: _this.commentDiv.element(by.css('.newCommentForm')).element(by.css('.commentRegarding')).element(by.css('.regardingInputSystem')),
        fieldValue: _this.commentDiv.element(by.css('.newCommentForm')).element(by.css('.commentRegarding')).element(by.css('.regardingFieldValue'))
      }
    },
