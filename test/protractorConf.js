...
exports.config = {
  ...
  // Put this back: specs: ['app/setupTestEnvironment.spec.js', 'app/**/e2e/*.spec.js', 'app/teardownTestEnvironment.spec.js'],
  specs: ['app/bellows/public/userProfile/e2e/*.spec.js'],
