...
class TestUserProfileDto extends UnitTestCase {
	...
	function testEncode_UserProjectHasUserProfileProperties_ReturnsProjectProperties() {
	...
	function testEncode_userProjectHasNoUserProfileProperties_noProjectSettings() {
		$e = new MongoTestEnvironment();
		$e->clean();
