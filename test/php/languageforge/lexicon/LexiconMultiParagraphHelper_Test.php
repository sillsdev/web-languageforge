...
class TestLexiconMultiParagraphHelper extends UnitTestCase
{
    ...
    {
        $inputSystem = 'en';
        $model = new \Api\Model\Languageforge\Lexicon\LexMultiParagraph();
        $model->inputSystem = $inputSystem;

        $paragraph1 = new \Api\Model\Languageforge\Lexicon\LexMultiParagraphItem();
        ...
        $paragraph2 = new \Api\Model\Languageforge\Lexicon\LexMultiParagraphItem();
        ...
        $paragraph3 = new \Api\Model\Languageforge\Lexicon\LexMultiParagraphItem();
