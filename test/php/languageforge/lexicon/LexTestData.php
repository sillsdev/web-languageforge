...
class LexTestData {
	...
	public static function Import($mergeRule, $skipSameModTime = false, $deleteMatchingEntry = false) {
		$import= array();
		$import['file'] = array();
		...
		return self::ImportSettings($import, $mergeRule, $skipSameModTime, $deleteMatchingEntry);
	}
/*
...
*/
	...
	public static function ImportSettings($import, $mergeRule, $skipSameModTime = false, $deleteMatchingEntry = false) {
		...
		$import['settings']['deleteMatchingEntry'] = $deleteMatchingEntry;
		return $import;
	}
