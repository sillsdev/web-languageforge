...
class ProjectPageDtoTest extends TestCase
{
    ...
    {
        list($projectId, $text1Id, $text2Id, $user1Id, $user2Id, $answer1Id, $answer2Id, $answer3Id, $question1Id, $question2Id, $comment0Id, $comment1Id, $comment2Id) = $this->createProjectForTestingResponseCountOnProjectPage();
