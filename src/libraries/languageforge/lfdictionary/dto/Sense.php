...
class Sense {
	...
	function __construct() {
		...
		$this->_definition = \libraries\languageforge\lfdictionary\dto\MultiText::create();
		$this->_partOfSpeech = '';
	...
	function decode($value) {
		...
		$this->_definition = \libraries\languageforge\lfdictionary\dto\MultiText::createFromArray($value['definition']);
