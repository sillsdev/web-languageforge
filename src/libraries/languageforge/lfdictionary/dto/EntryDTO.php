...
class EntryDTO {
	...
	private function __construct($guid=null) {
		$this->_guid = $guid;
		$this->_entry = new \libraries\languageforge\lfdictionary\dto\MultiText();
		$this->_senses = array();
	...
	function decode($value) {
		...
		$this->_entry = \libraries\languageforge\lfdictionary\dto\MultiText::createFromArray($value['entry']);
