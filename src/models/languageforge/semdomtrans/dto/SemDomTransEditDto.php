...
class SemDomTransEditDto
{
     ...
     * @param number $offset
     * @return multitype:boolean number multitype: multitype:string  Ambigous <\models\mapper\string;, multitype:, string, Ambigous <multitype:, multitype:multitype: unknown >, Ambigous <multitype:, \stdClass, multitype:multitype: unknown >, Ambigous <string, multitype:NULL string >>
     */
