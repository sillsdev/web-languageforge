...
/*
 ...
 |
 | Syntax to make that change: db.users.update({'email': 'admin@admin.com'}, {'$set': {'password': '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36'}})
 |
 ...
 */
$config['site_title']                 = "Scripture Forge";       // Site Title, example.com
$config['admin_email']                = "admin@scriptureforge.org"; // Admin Email, admin@example.com
