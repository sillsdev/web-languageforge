			...
			<div id="slides">
				<div class="slides_container">
					...
					<div class="slides_content">
						<img src="<?php echo "/images/languageforge/default/" . $slide['image_url'] ?>" alt="<?php $slide['image_url'] ?>" width="300" height="349" style="margin-top:20px; border: 2px solid grey" class="left png_bg">
