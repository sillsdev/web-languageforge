...
class Ion_auth_mongodb_model extends CI_Model
{
    ...
    public function update($id, array $data)
    {
        ...
        $updated = $this->mongo_db
            ->where('_id', new MongoId($user->_id)) // https://github.com/benedmunds/CodeIgniter-Ion-Auth/pull/460
            ->set($data)
            ->update($this->collections['users']);
    ...
    public function login_remembered_user()
    {
        ...
        if (count($document)) {
            ...
            $this->update_last_login($user->_id); // https://github.com/benedmunds/CodeIgniter-Ion-Auth/issues/457
